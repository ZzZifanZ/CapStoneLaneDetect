function [velo_img, pt] = run_demoVelodyneTest (base_dir,calib_dir,f,c)
...
[model1,inlierIdx,outlierIdx] = pcfitplane(ptCloud,maxd,normalv,maxAngularDistance);
road = select(ptCloud,inlierIdx);
